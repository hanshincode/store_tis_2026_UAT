...
# DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@tisbroker.local")
...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = "email-cua-ban@outlook.com"
# EMAIL_HOST_PASSWORD = "mat-khau-ung-dung-hoac-mat-khau-chinh" 
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL") or EMAIL_HOST_USER or "no-reply@tisbroker.local"
...
ALLOWED_HOSTS = env_list(
    "DJANGO_ALLOWED_HOSTS",
    ["localhost", "127.0.0.1", "[::1]", "100.96.50.61"] if DEBUG else ["100.96.50.61"],
)
# Application definition
